...
<head>
	...
	<div class="banner-text">
		<h1>Blood Bank</h1>
		<p>Blood Donation</p>
	<link rel="stylesheet" type="text/css" href="css/s12.css">
...
<br><br><br>
	...
	<input id="a_id" type="text" name="a_id" placeholder="Acceptor ID"  style="width: 150px;height: 30px;border: none; border-bottom: 2px solid aqua;"/>
...
<?php
 ...
 $q=$db->prepare("INSERT INTO receives_from(a_id,h_id,test_date) VALUES (:a_id,:h_id,:test_date)");
 ...
 $q->bindValue('test_date',$test_date);
      ...
      if($q->execute())
            {
              echo "<script>alert('Receipt Registered Successfull')</script>";
            }
            else
            {
              echo "<script>alert('Receipt Registered Unsuccessfull')</script>";
            }
         } 
           ?>
	...
	<div id="sideNav">
		<nav>
			<ul>
				<li><a href="admin-main.php">Information</a></li>
				<li><a href="donation-reg.php">Rgister Donation</a></li>
