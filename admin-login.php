...
<body>
  ...
  <form action="" method="post">
      <table align="center">
        <tr>
          <td align="center" width="100px" height="50px"><input type="text"name="un" id="aa_id" placeholder="Enter ID" style="width: 150px;height: 30px;border: none; border-bottom: 2px solid aqua;"></td>
        </tr>
        <tr>
      ...
      if(isset($_POST['sub']))
      {
         $un=$_POST['un'];
         $ps=$_POST['ps'];
         $q=$db->prepare("SELECT * FROM technician WHERE Tec_id='$un' && Tec_pass='$ps'");
         $q->execute();
